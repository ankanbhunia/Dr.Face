...
def main():
    ...
    detected_pre = []
    res = {}
    for path_i in glob.glob('/data/SFSFS/data_dst/aligned/*.jpg'):
        print (path_i)
        # get video frame
        ...
        if img_idx==1 or img_idx%skip_frame == 0:
            ...
            input_img, p_r = draw_results(detected,input_img,faces,ad,img_size,img_w,img_h,model,time_detection,time_network,time_plot)
            res[path_i] = p_r
    ...
    np.save('/content/data_dst_pose', res)      
