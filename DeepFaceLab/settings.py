...
if params['facetype'] == '0': Face_Type = 'head'
if params['facetype'] == '1': Face_Type = 'wf'
if params['facetype'] == '2': Face_Type = 'f'

if params['Quality'] == '1': Resolution = 640 ; Output_image_Resolution = 1080
if params['Quality'] == '2': Resolution = 256 ; Output_image_Resolution = 512
if params['Quality'] == '3': Resolution = 128 ; Output_image_Resolution = 480
if params['Quality'] == '4': Resolution = 64 ; Output_image_Resolution = 256



dv = params['device'].split(',')
if dv == ['C']: 
	force_device = 'CPU'
else:  
	if 'C' in dv: dv.remove('C')
	dv = ','.join(dv)
	force_device = dv

if params['Batchsize'] == '1':
	
	force_batch_size = 'Auto'
else:
	force_batch_size = int(params['Batchsize'])
