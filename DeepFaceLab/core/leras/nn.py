    ...
    def ask_choose_device_idxs(choose_only_one=False, allow_cpu=True, suggest_best_multi_gpu=False, suggest_all_gpu=False):
        ...
        while True:
            try:
                ...
                if choose_only_one:
                    choosed_idxs = settings.force_device #io.input_str("Which GPU index to choose?", best_device_indexes)
                else:
                    choosed_idxs = settings.force_device#io.input_str("Which GPU indexes to choose?", best_device_indexes)
